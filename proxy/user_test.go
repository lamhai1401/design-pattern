...
func TestUserListProxy(t *testing.T) {
	...
	t.Run("FindUser - Empty cache", func(t *testing.T) {
		...
		if len(proxy.StackCache) != 1 {
			t.Error("After one successful search in an empty cache, the size of itmust be one")
		}
	...
	t.Run("FindUser - overflow the StackCache array on the proxy typ", func(t *testing.T) {
